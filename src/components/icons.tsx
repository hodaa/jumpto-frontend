...
/** Share icon used for per-result share actions. */
...
/** Check icon used for transient "copied" feedback. */
...
/** YouTube logo used for the "watch on YouTube" action. */
export function IconYouTube({ size = 16 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
