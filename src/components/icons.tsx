...
/** Magnifier icon used for the empty-results state. */
...
/** Copy icon used for the "copy all results" action. */
...
/** Download icon used for the "export CSV" action. */
...
/** Clipboard icon used for the inline Paste action. */
...
/** Info icon used for helper/disclosure text. */
...
/** X / close icon used for per-field clear buttons. */
